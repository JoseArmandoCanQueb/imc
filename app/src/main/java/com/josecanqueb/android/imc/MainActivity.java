package com.josecanqueb.android.imc;
...
public class MainActivity extends AppCompatActivity {
    ...
    public EditText mCampoPeso;
    public EditText mCampoEstatura;
    public Button mBotonCalcular;
    public Button mBotonLimpiar;
    public TextView mEtiquetaImc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBotonCalcular = (Button) findViewById(R.id.boton_calculaar);
